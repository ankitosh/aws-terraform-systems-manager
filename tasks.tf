resource "aws_ssm_maintenance_window_task" "task" {
  ...
  service_role_arn   = "${var.service_role_arn}" #"arn:aws:iam::366775409521:role/AutomationServiceRole
  max_concurrency  = "4"
  max_errors       = "1"
...
resource "aws_ssm_maintenance_window_task" "amaznlin" {
  ...
  priority         = 1
  #service_role_arn  =  "${module.AutomationServiceRole.arn}"
  service_role_arn   = "${var.service_role_arn}" #"arn:aws:iam::366775409521:role/AutomationServiceRole"#"${var.service_role_arn}"
  max_concurrency  = "4"
  max_errors       = "1"
